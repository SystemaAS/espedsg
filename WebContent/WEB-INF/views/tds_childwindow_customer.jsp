...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tds_childwindow_customer.js?ver=${user.versionEspedsg}"></SCRIPT>
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<table id="customerList" class="display compact cell-border" width="100%" >
						...
						<tr style="background-color:#EEEEEE">
		                    ...
		                    <th class="text11" >&nbsp;Namn&nbsp;</th>
		                    <th class="text11" >&nbsp;EORI&nbsp;</th>
		                    <th class="text11" >&nbsp;Adress&nbsp;</th>
		                    <th class="text11" >&nbsp;Postadress&nbsp;</th>
