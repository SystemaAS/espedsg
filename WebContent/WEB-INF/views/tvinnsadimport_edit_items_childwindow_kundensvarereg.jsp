				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						...
						<tr>
							...
							<td class="text11">&nbsp;</td>
	           				<td class="text11">&nbsp;Kundenr.(Mottaker)</td>
							<td class="text11">&nbsp;<input type="text" class="inputText" name="recId" id="recId" size="10" maxlength="20" value="${model.recId}"></td>
							<td class="text11">&nbsp;</td>
					...
					<table id="kundensVareRegList" class="display compact cell-border" width="100%" >
						...
						<tr style="background-color:#EEEEEE">
		                    ...
		                    <th class="text11" title="adunnr">&nbsp;Tollverdi&nbsp;</th>
		                    <th class="text11" title="adunnr">&nbsp;Bruttovekt&nbsp;</th>
		                    <th class="text11" title="adunnr">&nbsp;Nettovekt&nbsp;</th>
		                </tr> 
		                </thead>
		                <tbody>
		                <c:forEach var="record" items="${model.kundensVareRegList}" varStatus="counter">    
			               ...
			               <td nowrap style="cursor:pointer;" class="text11MediumBlue" id="varenr${record.varenr}@varebe${record.varebe}@w2vnti${record.w2vnti}@w2belt${record.w2belt}@w2vktb${record.w2vktb}@w2vktn${record.w2vktn}" >
               			   		<img title="select" valign="bottom" src="resources/images/update.gif" border="0" alt="edit">&nbsp;${record.varenr}
			               </td>
		               	   <td class="text11">&nbsp;${record.w2vnti}</td>
		               	   <td class="text11">&nbsp;${record.varebe}</td>
		               	   <td class="text11">&nbsp;${record.w2belt}</td>
		               	   <td class="text11">&nbsp;${record.w2vktb}</td>
		               	   <td class="text11">&nbsp;${record.w2vktn}</td>
			            </tr> 
			            </c:forEach>
			            </tbody>
		            </table>
