					   ...
					   <c:choose>
							<c:when test="${model.level == 'EDISS'}">
				                ...
				                <c:forEach var="record" items="${model.list}" varStatus="counter">    
					               <tr class="text11">
					               <td style="cursor:pointer;" class="text11MediumBlue" id="id${record.sssn}@date${record.ssdt}@time${record.sstm}" >
				            ...
				            <c:otherwise>
				            	<thead>
								<tr style="background-color:#EEEEEE">
									<th class="text11" title="ssssn">&nbsp;Interch.nr&nbsp;</th>
				               	   	<th class="text11" title="sssdt">&nbsp;Date&nbsp;</th>
				                    <th class="text11" title="ssstm">&nbsp;Time&nbsp;</th>
				                    <th class="text11" title="sssdata">&nbsp;Log data&nbsp;</th>
				                </tr> 
				                </thead>
				                ...
				                <c:forEach var="record" items="${model.list}" varStatus="counter">    
					               <tr class="text11">
					               <td id="" style="cursor:pointer;" class="text11MediumBlue" >
					               		<img title="select" valign="bottom" src="resources/images/bebullet.gif" border="0" alt="Interchange nr">&nbsp;${record.ssssn}
					               </td>
				               	   <td class="text11">&nbsp;${record.sssdt}</td>
				               	   <td class="text11">&nbsp;${record.ssstm}</td>
				               	   <td class="text11">&nbsp;${record.sssdata}</td>
