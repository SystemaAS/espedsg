	...
	<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25"> 
			<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatnctsimport.do?action=doFind&sign=${model.sign}">
			...
			<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatnctsimport_edit.do?action=doFetch&avd=${model.avd}&opd=${model.opd}
			...
			<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
			<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatnctsimport_unloading_edit.do?avd=${model.avd}&sign=${model.sign}&opd=${model.opd}
			...
			<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
			<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatnctsimport_unloading_edit_items.do?action=doFetch&avd=${model.avd}&sign=${model.sign}
			...
			<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
			<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatnctsimport_logging.do?avd=${model.avd}&sign=${model.sign}
									&opd=${model.opd}&mrnNr=${model.mrnNr}&godsNr=${model.godsNr}
									&status=${model.status}&datum=${model.datum}">
					<font class="tabDisabledLink">
			...
			<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
			<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatnctsimport_archive.do?avd=${model.avd}&sign=${model.sign}
									&opd=${model.opd}&mrnNr=${model.mrnNr}&godsNr=${model.godsNr}
									&status=${model.status}&datum=${model.datum}">
					<font class="tabDisabledLink">
								        ...
								        <span style="background-color:#EEEEEE; position:absolute; left:50px; top:200px; width:1100px; height:1000px;" id="allItems" class="popupWithInputTextThickBorder"  >
							           		<div class="ownScrollableSubWindow" style="width:1080px; height:900px; margin:10px;">
										         ...
										         <tr>
													...
													<%-- OK BUTTON --%>
							           				<tr align="left" >
														<td class="text11"><button name="allItemsButtonClose" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('allItems');">&nbsp;<spring:message code="systema.skat.ok"/></button> 
														</td>
													</tr>
													</table>
													</td>
					 		...
					 		<td colspan="3">
						 		<table class="tableBorderWithRoundCornersGray" width="80%" border="0" cellspacing="0" cellpadding="0">
							 		<tr>
										...
										<td class="text12" align="left" valign="bottom">
											&nbsp;<span title="tvstsk" >Sprogkode</span>
					        ...
					        <td valign="top">
						 		<table width="100%" align="left" border="0" cellspacing="0" cellpadding="0">
							 		...
							 		<tr>
							 			...
							 			<td class="text12" align="left" valign="bottom">
											&nbsp;<span title="tvgmsk" >Sprogkode</span>
											<a tabindex="-1" class="text14" target="_blank" href="${model.isoLanguageCodesURL.value}" onclick="${model.isoLanguageCodesURL.windowOpenDimensions}" >
							            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
							            		</a>
										</td>
						            ...
						            <tr>
							            <td class="text12" align="left" valign="bottom">
											&nbsp;<span title="tvgmlk" >Godk.landkode</span>
							 					<a tabindex="-1" class="text14" target="_blank" href="${model.skatLandCodesURL.value}" onclick="${model.skatLandCodesURL.windowOpenDimensions}" >
								            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
								            		</a>
										</td>
										<td class="text12" align="left" valign="bottom">
							 			...
							 			<td class="text12" align="left" valign="bottom">
											&nbsp;<span title="tvgmss" >Sprogkode</span>
											<a tabindex="-1" class="text14" target="_blank" href="${model.isoLanguageCodesURL.value}" onclick="${model.isoLanguageCodesURL.windowOpenDimensions}" >
							            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
							            		</a>
										</td>
				        		...
				        		<td >
					        		<table width="80%" align="left" border="0" cellspacing="0" cellpadding="0">
					        			<tr>
							 			...
							 			<td class="text12" align="left" valign="bottom">
											&nbsp;<span title="tvdfsk" >Sprogkode</span>
											<a tabindex="-1" class="text14" target="_blank" href="${model.isoLanguageCodesURL.value}" onclick="${model.isoLanguageCodesURL.windowOpenDimensions}" >
							            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
							            		</a>
										</td>
		 				    ...
		 				    <c:choose>
			 				    <c:when test="${ model.status == 'F' || model.status == 'M' || empty model.status}">
				 				    <td class="text9BlueGreen" valign="bottom"  >
					 				    	<input tabindex=-1 class="inputFormSubmit" type="submit" name="submit" onclick="javascript: form.action='skatnctsimport_edit_items.do';" value="<spring:message code="systema.skat.ncts.import.item.createnew.submit"/>"/>
					 				</td>    	
			 				    </c:when>
			 				    <c:otherwise>
						 		...
						 		<tr>
							 		<td valign="top" width="50%">
							 			...
							 			<tr>
								 			...
								 			<td class="text12" align="left" valign="bottom">
												&nbsp;<span title="tvtask" >Sprogkode</span>
												<a tabindex="-1" class="text14" target="_blank" href="${model.isoLanguageCodesURL.value}" onclick="${model.isoLanguageCodesURL.windowOpenDimensions}" >
								            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
								            		</a>
											</td>
						 			...
						 			<td valign="top" width="50%">
							 			...
							 			<tr>
								 			...
								 			<td class="text12" align="left" valign="bottom">
												&nbsp;<span title="tvomsk" >Sprogkode</span>
												<a tabindex="-1" class="text14" target="_blank" href="${model.isoLanguageCodesURL.value}" onclick="${model.isoLanguageCodesURL.windowOpenDimensions}" >
								            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
								            		</a>
											</td>
							            ...
							            <tr>
								            <td class="text12" align="left" valign="bottom">
												&nbsp;<span title="tvomlk" >Godk.landkode</span>
							 					<a tabindex="-1" class="text14" target="_blank" href="${model.skatLandCodesURL.value}" onclick="${model.skatLandCodesURL.windowOpenDimensions}" >
								            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
								            		</a>
											</td>
											<td class="text12" align="left" valign="bottom">
								 			...
								 			<td class="text12" align="left" valign="bottom">
												&nbsp;<span title="tvomss" >Sprogkode</span>
												<a tabindex="-1" class="text14" target="_blank" href="${model.isoLanguageCodesURL.value}" onclick="${model.isoLanguageCodesURL.windowOpenDimensions}" >
								            			<img style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" >
								            		</a>
											</td>
