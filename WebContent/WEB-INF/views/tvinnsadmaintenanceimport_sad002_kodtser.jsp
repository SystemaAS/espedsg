...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadmaintenanceimport_sad002_kodtser.js?ver=${user.versionEspedsg}"></SCRIPT>	
			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tab" align="center">
						<font class="tabLink">&nbsp;SAD002 / KODTSE</font>&nbsp;
						<a id="alinkRecordId_${counter.count}" onClick="setBlockUI(this);" href="tvinnsadmaintenanceimport_sad002_kodtser.do?id=${model.dbTable}">
		...
		<%-- space separator --%>
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td align="center" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="tvinnsadmaintenanceimport_sad002_kodtser_edit.do?action=doDelete&id=${model.dbTable}&ksefyl=${record.ksefyl}">
			...
			<tr height="2"><td>&nbsp;</td></tr>
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="tvinnsadmaintenanceimport_sad002_kodtser_edit.do" name="formRecord" id="formRecord" method="POST" >
