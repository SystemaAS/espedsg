...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadmaintenanceimport_sad002_kodts5r.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<%-- space separator --%>
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td id="recordUpdate_${record.ks5tln}" onClick="getRecord(this);" align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<img src="resources/images/update.gif" border="0" alt="edit">
				               </td>
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text12">&nbsp;${record.ks5tln}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text12">&nbsp;${record.ks5ftx}&nbsp;</font></td>
				               <td align="center" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="tvinnsadmaintenanceimport_sad002_kodts5r_edit.do?action=doDelete&id=${model.dbTable}&ks5tln=${record.ks5tln}">
							...
							<tr>
								<th class="tableHeaderField" >&nbsp;Endre&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;KS5TLN</th>
			                    <th class="tableHeaderField" >&nbsp;KS5FTX&nbsp;</th>
								<th class="tableHeaderField">Slett</th>
			                </tr>  
			                </tfoot> 
			            </table>
			...
			<tr height="2"><td>&nbsp;</td></tr>
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="tvinnsadmaintenanceimport_sad002_kodts5r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="60%" cellspacing="1" border="0" align="left">
			    	    <tr>
						<td class="text12" title="KS5TLN">&nbsp;<font class="text14RedBold" >*</font>Kode</td>
						<td class="text12" title="KS5FTX">&nbsp;<font class="text14RedBold" >*</font>Fritekst</td>
