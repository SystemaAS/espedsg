...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadmaintenanceimport_sad002_kodtsbr.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<%-- space separator --%>
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td id="recordUpdate_${record.ksbkd}" onClick="getRecord(this);" align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<img src="resources/images/update.gif" border="0" alt="edit">
				               </td>
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text12">&nbsp;${record.ksbkd}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text12">&nbsp;${record.ksbft}&nbsp;</font></td>
				               <td align="center" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="tvinnsadmaintenanceimport_sad002_kodtsbr_edit.do?action=doDelete&id=${model.dbTable}&ksbkd=${record.ksbkd}">
							...
							<tr>
								<th class="tableHeaderField" >&nbsp;Endre&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;KSBKD</th>
			                    <th class="tableHeaderField" >&nbsp;KSBFT&nbsp;</th>
								<th class="tableHeaderField">Slett</th>
			                </tr>  
			                </tfoot> 
			            </table>
			...
			<tr height="2"><td>&nbsp;</td></tr>
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="tvinnsadmaintenanceimport_sad002_kodtsbr_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="60%" cellspacing="1" border="0" align="left">
			    	    <tr>
						<td class="text12" title="KSBKD">&nbsp;<font class="text14RedBold" >*</font>Doc.type</td>
						<td class="text12" title="KSBFT">&nbsp;<font class="text14RedBold" >*</font>Fritekst</td>
