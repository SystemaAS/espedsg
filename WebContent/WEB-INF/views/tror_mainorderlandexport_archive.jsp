...
<!-- =====================end header ==========================-->
<SCRIPT type="text/javascript" src="resources/js/tror_mainorderlandexport_archive.js?ver=${user.versionEspedsg}"></SCRIPT>
		...
		<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
			...
			<tr height="25"> 
				...
				<td width="12%" valign="bottom" class="tab" align="center" nowrap>
					...
					<font class="tabLink"><spring:message code="systema.tror.order.archive.tab"/></font>&nbsp;<font class="text10Orange">F8</font>
				</td>
