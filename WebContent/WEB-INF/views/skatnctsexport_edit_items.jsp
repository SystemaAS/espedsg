					 		...
					 		<td>
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
										...
										<td class="text12" align="left"><input type="text" class="inputText" name="tvdref" id="tvdref" size="20" maxlength="20" value="${model.record.tvdref}"></td>
