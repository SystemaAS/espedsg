...
<!-- =====================end header ==========================-->
<SCRIPT type="text/javascript" src="resources/js/tror_mainorderlandexport_logging.js?ver=${user.versionEspedsg}"></SCRIPT>
		...
		<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
			...
			<tr height="25"> 
				...
				<td width="12%" valign="bottom" class="tab" align="center" nowrap>
					...
					<font class="tabLink"><spring:message code="systema.tror.order.logging.tab"/></font><font class="text12">&nbsp;</font>&nbsp;<font class="text10Orange">F7</font>
			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
	               ...
	               <tbody>     
		               ...
		               <td class="tableCell">&nbsp;
		               		<a <c:if test="${record.msr == 'R'}">style="color:#9F6000;"</c:if>  href="tror_mainorderlandexport_renderEdifact.do?fp=${record.wurl}" target="_new" >
		               ...
		               <td class="tableCell" <c:if test="${record.msr == 'R'}">style="color:#9F6000;"</c:if> >&nbsp;${record.wtxt}
		               		<c:if test="${record.wmore == 'X'}">
		               			&nbsp;&nbsp;
		               			<a href="tror_mainorderlandexport_renderLargeText.do?fmn=${record.mmn}" target="_blank" onClick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=500'); return false;">
