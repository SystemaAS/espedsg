...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tdsexport_edit_items_childwindow_tulltaxa.js?ver=${user.versionEspedsg}"></SCRIPT>
	
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		<tr>
			<td colspan="3" class="text14Bold">&nbsp;Sök kod</td>
		</tr>
		<tr>
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						<table>
						<form name="tdsExportTulltaxaForm" id="tdsExportTulltaxaForm" action="tdsexport_edit_items_childwindow_tulltaxa.do?action=doInit" method="post">
						<tr>
					...
					<table id="tullTaxaList" class="display compact cell-border" width="100%" >
						...
						<tr style="background-color:#EEEEEE">
							<th class="text11" title="adunnr">&nbsp;Grupp&nbsp;</th>
							<th class="text11" title="adunnr">&nbsp;Varukod&nbsp;</th>
