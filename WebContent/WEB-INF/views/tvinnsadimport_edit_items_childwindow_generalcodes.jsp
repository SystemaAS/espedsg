...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadimport_edit_items_childwindow_generalcodes.js?ver=${user.versionEspedsg}"></SCRIPT>
