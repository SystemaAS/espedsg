	...
	<table width="90%" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<tr>
			<td colspan="3" class="text14Bold">&nbsp;&nbsp;&nbsp;
				...
				<spring:message code="systema.tror.childwindow.tollsted.label.title"/>
			</td>
		</tr>
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%">
					...
					<table id="tollstedList" class="display compact cell-border" width="100%">
		                ...
		                <c:forEach var="record" items="${model.tollstedList}" varStatus="counter">    
			               ...
			               --%>
			               <td width="2%" class="text11MediumBlue" style="cursor:pointer;" id="id_${record.ktskod}@name_${record.ktsnav}@counter_${counter.count}">
			               	 	${record.ktskod}
			               </td>
