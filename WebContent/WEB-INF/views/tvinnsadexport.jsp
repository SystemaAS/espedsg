...
<tr>
	...
	<%-- search filter component --%>
 		...
 		<table width="100%" class="tabThinBorderWhite" border="0" cellspacing="0" cellpadding="0">
 	        ...
 	        <tr>	
                <td class="text12" align="left" title="avd">&nbsp;&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.avd"/></td>
                <td class="text12" align="left" title="sg">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.signatur"/></td>
                <td class="text12" align="left" title="opd">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.arende"/></td>
                <td class="text12" align="left" title="h_xref">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.extrefnr"/></td>
                ...
                <td class="text12" align="left" title="avsNavn">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.avsandare"/></td>
                <td class="text12" align="left" title="motNavn">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.mottagare"/></td>
                <td class="text12" align="left" title="sign">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.godsnr"/></td>
                <td class="text12" align="left" title="semi">&nbsp;&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.innstikk"/></td>
			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					<tr class="tableHeaderField" height="20" valign="left">
	                    ...
	                    <td class="tableHeaderField" nowrap>&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.lopenr"/>&nbsp;</td>
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.status"/>&nbsp;</td>
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.tvinn.sad.export.list.search.label.avsandare"/>&nbsp;</td>
		               ...
		               <td class="tableCell" >&nbsp;
							...
							<div style="display: none;" class="clazz_dialog" id="dialog${counter.count}" title="Dialog">
								<form  action="tvinnsadexport_copyTopic.do" name="copyForm${counter.count}" id="copyForm${counter.count}" method="post">
									...
									<p class="text12" >Du må velge nye&nbsp;<code>Avdeling</code>&nbsp;og ny&nbsp;
										<code>Signatur</code> for å kunne kopiere en tolldeklarasjon
									</p>
									<p class="text12" >En ny Tolldeknr. vil bli opprettet automatisk.
									</p>
