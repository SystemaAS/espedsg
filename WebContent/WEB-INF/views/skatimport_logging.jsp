			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					<tr class="tableHeaderField" height="20" valign="left">
	                    ...
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.skat.import.logging.list.label.sentReceive"/>&nbsp;</td>
		               ...
		               <td class="tableCell" >&nbsp;
		               		<a <c:if test="${record.msr == 'R'}">style="color:#9F6000;"</c:if> href="skat_import_renderEdifact.do?fp=${record.wurl}" target="_new" >
