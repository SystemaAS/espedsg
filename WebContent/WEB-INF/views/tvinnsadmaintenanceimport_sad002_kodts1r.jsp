...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadmaintenanceimport_sad002_kodts1r.js?ver=${user.versionEspedsg}"></SCRIPT>	
			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tab" align="center">
						<font class="tabLink">&nbsp;SAD002 / KODTTS1</font>&nbsp;
						<a id="alinkRecordId_${counter.count}" onClick="setBlockUI(this);" href="tvinnsadmaintenanceimport_sad002_kodts1r.do?id=${model.dbTable}">
		...
		<%-- space separator --%>
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td id="recordUpdate_${record.ks1typ}" onClick="getRecord(this);" align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<img src="resources/images/update.gif" border="0" alt="edit">
				               </td>
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text12">&nbsp;${record.ks1typ}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text12">&nbsp;${record.ks1ftx}&nbsp;</font></td>
				               <td align="center" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="tvinnsadmaintenanceimport_sad002_kodts1r_edit.do?action=doDelete&id=${model.dbTable}&ks1typ=${record.ks1typ}">
							...
							<tr>
								<th class="tableHeaderField" >&nbsp;Endre&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;KS1TYP</th>
			                    <th class="tableHeaderField" >&nbsp;KS1FTX&nbsp;</th>
								<th class="tableHeaderField">Slett</th>
			                </tr>  
			                </tfoot> 
			            </table>
			...
			<tr height="2"><td>&nbsp;</td></tr>
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="tvinnsadmaintenanceimport_sad002_kodts1r_edit.do" name="formRecord" id="formRecord" method="POST" >
