	...
	<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25"> 
			<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a tabindex=-1 style="display:block;" href="skatimport.do?action=doFind&sign=${model.record.dkih_sysg}">
			...
			<c:choose> 
			    <c:when test="${editActionOnTopic=='doUpdate' or editActionOnTopic=='doFetch'}">
					...
					<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a tabindex=-1 style="display:block;" href="skatimport_edit_items.do?action=doFetch&avd=${ model.record.dkih_syav}&sign=${ model.record.dkih_sysg}
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a tabindex=-1 style="display:block;" href="skatimport_logging.do?avd=${ model.record.dkih_syav}&sign=${ model.record.dkih_sysg}
													&opd=${ model.record.dkih_syop}&refnr=${ model.record.dkih_07}
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a tabindex=-1 style="display:block;" href="skatimport_archive.do?avd=${model.record.dkih_syav}&sign=${model.record.dkih_sysg}
													&opd=${model.record.dkih_syop}&refnr=${model.record.dkih_07}
													&status=${model.record.dkih_syst}&datum=${model.record.dkih_sydt}">
							<font class="tabDisabledLink">
	            	...
	            	<table align="left" border="0" cellspacing="0" cellpadding="0">
				 		...
				 		<tr>
				 			<td class="text12">
			 					...
			 					<span title="dkih_r011">Ang.type&nbsp;</span>
				 			</td>
				 			<td>
			 				...
			 				<span style="position:absolute; left:800px; top:150px; width:250px; height:200px;" id="meddTyp_info" class="popupWithInputText"  >
				           		<div class="text11" align="left">
					           		<ul>
			 				...
			 				<font class="text16RedBold" >*</font>
			 				<span title="dkih_aart">Ang.art&nbsp;</span></td>
				 			<td>
		 				...
		 				<tr>
			 				...
			 				<td class="text12">&nbsp;
				 				...
				 				<span style="position:absolute; left:800px; top:150px; width:250px; height:200px;" id="ens_flag_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
						           		<b>ENS-flag</b>
						           		<ul>
						           			<li><b>1</b>
						...
						<tr>
		 					<td class="text12" >
				 				...
				 				<span style="position:absolute; left:800px; top:150px; width:300px; height:140px;" id="dkih_dtm1_info" class="popupWithInputText" >
					           		<div class="text11" align="left">
				 			...
				 			<td class="text12">
				 				...
				 				<span style="position:absolute; left:800px; top:150px; width:300px; height:140px;" id="dkih_dtm2_info" class="popupWithInputText" >
					           		<div class="text11" align="left">
						 		...
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
							            ...
							            <span title="dkih_02b" id="v_dkih_02b" class="validation">Navn&nbsp;</span>
							            	...
							            	<%-- =====================================================  --%>
							            	<span style="position:absolute; left:500px; top:280px; width:300px; height:250px;" id="searchCustomerDialog" class="popupWithInputText"  >
								           		<div class="text10" align="left">
								           			<table>
								           				<tr>
															<td class="text11">&nbsp;Kundenummer</td>
															<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_avkn" id="search_dkih_avkn" size="18" maxlength="8" value=""></td>
														</tr>
									           			<tr>
															<td class="text11">&nbsp;Navn</td>
															<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_02b" id="search_dkih_02b" size="18" maxlength="35" value=""></td>
														</tr>
									           			<tr>
									           				<td class="text11">&nbsp;</td>
										           			<td align="right">&nbsp;<button name="searchCustomer" id="searchCustomer" class="buttonGray" type="button" onClick="searchSenderOwnWindow()"><spring:message code="systema.skat.import.search"/></button></td>
										           		</tr>
										           		...
										           		<tr>
															...
															<%-- <input type="hidden" name="hidden_svih_avkn" id="hidden_svih_avkn" value=''> --%>
														</tr>
								           			</table>
													<table width="30%" align="left" border="0">
														<tr align="left" >
															<td >&nbsp;<button name="searchCustomerCloseOk" id="searchCustomerCloseOk" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog');"><spring:message code="systema.skat.import.ok"/></button></td>
															<td >&nbsp;<button name="searchCustomerCloseCancel" id="searchCustomerCloseCancel" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog');"><spring:message code="systema.skat.import.cancel"/></button></td>
														</tr>
													</table>
												</div>
											</span>				
	 				...
	 				<table width="100%" align="left" class="formFrameHeader" border="0" cellspacing="0" cellpadding="0">
				 		<tr height="15">
				 			<td class="text12White">
				 				...
				 				<font class="text16RedBold" >*</font>Modtager&nbsp;<img valign="bottom" src="resources/images/update.gif" border="0" alt="edit">
			 				</td>
		 				</tr>
	 				</table>
	 			</td>
							            	...
							            	<span style="position:absolute; left:500px; top:550px; width:300px; height:250px;" id="searchCustomerDialog10" class="popupWithInputText"  >
								           		<div class="text10" align="left">
								           			<table>
								           				<tr>
															<td class="text11">&nbsp;Kundenummer</td>
															<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_mokn" id="search_dkih_mokn" size="18" maxlength="8" value=''></td>
														</tr>
									           			<tr>
															<td class="text11">&nbsp;Navn</td>
															<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_08b" id="search_dkih_08b" size="18" maxlength="35" value=''></td>
														</tr>
									           			<tr>
									           				<td class="text11">&nbsp;</td>
										           			<td align="right">&nbsp;<button name="searchCustomer10" id="searchCustomer10" class="buttonGray" type="button" onClick="searchReceiverOwnWindow()"><spring:message code="systema.skat.import.search"/></button></td>
										           		</tr>
										           		<tr height="4"><td ></td></tr>
										           		<tr>
									           				<td class="text11">&nbsp;Udvalg</td>
													...
													<table width="30%" align="left" border="0">
														<tr align="left" >
															<td >&nbsp;<button name="searchCustomer10CloseOk" id="searchCustomer10CloseOk" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog10');"><spring:message code="systema.skat.import.ok"/></button></td>
															<td >&nbsp;<button name="searchCustomer10CloseCancel" id="searchCustomer10CloseCancel" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog10');"><spring:message code="systema.skat.import.cancel"/></button></td>
														</tr>
													</table>
												</div>
											</span>	
			 			...
			 			<table border="0" cellspacing="0" cellpadding="0">
					 		<tr>
					            ...
					            <img onMouseOver="showPop('15_a_info');" onMouseOut="hidePop('15_a_info');"style="vertical-align:top;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
			 					<b>15.</b>
			 					<span style="position:absolute; left:800px; top:150px; width:250px; height:240px;" id="15_a_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					            ...
					            <font class="text16RedBold" >*</font>
					            <span title="dkih_15">Afsend.land</span>&nbsp;</td>
					            <td >
							...
							<tr>
					            ...
					            <span title="dkih_181" id="v_dkih_181" class="validation">Transp.ID</span></td>
				                 <td >
							...
							<tr>
					            ...
					            <img onMouseOver="showPop('18_a_info');" onMouseOut="hidePop('18_a_info');"style="vertical-align:top;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
			 					<b>18.2</b>
			 					<span style="position:absolute; left:800px; top:150px; width:250px; height:240px;" id="18_a_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					           			<b>18.2 TODO</b>
					           			<br/><br/>
					           			-
					            ...
					            <span title="dkih_18a">Transp.ref.</span></td>
				                 <td >
			 		...
			 		<td>
			 			<table border="0" cellspacing="1" cellpadding="0">
			 				<tr>
					            ...
					            <b>25.</b>
					            <span title="dkih_25" id="v_dkih_25" class="validation">Transp. ved grænsen&nbsp;</span></td>
			 		...
			 		<td>
			 			<table border="0" cellspacing="1" cellpadding="0">
					 		...
					 		<tr>
					            ...
					            <b>26.</b>
					            <span title="dkih_26" id="v_dkih_26" class="validation">Indenlandsk transp.måde&nbsp;</span></td>
					...
					<td valign="top">
			 			<table border="0" cellspacing="0" cellpadding="0">
					 		<tr>
					            ...
					            <span title="dkih_s29"><b>S29.</b>&nbsp;Bet.måde for transp.udgifter</span>&nbsp;</td>
					            <td >
				            ...
				            <img onMouseOver="showPop('dkih_201_info');" onMouseOut="hidePop('dkih_201_info');"style="vertical-align:top;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
		 					<span title="dkih_201">&nbsp;Leveringsbetingelser [kode]</span>&nbsp;</td>
				            <span style="position:absolute; left:800px; top:150px; width:250px; height:520px;" id="dkih_201_info" class="popupWithInputText"  >
				           		<div class="text11" align="left">
				            ...
				            <td >
			 				...
			 				<tr>
					            ...
					            <img onMouseOver="showPop('dkih_202_info');" onMouseOut="hidePop('dkih_202_info');"style="vertical-align:top;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
			 					<span title="dkih_202">&nbsp;Sted</span>&nbsp;</td>
					            <span style="position:absolute; left:800px; top:150px; width:250px; height:520px;" id="dkih_202_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					           			<b>Sted</b>
					           			<br/><br/>
			 		...
			 		<td>
			 			<table border="0" cellspacing="1" cellpadding="0">
				            ...
				            <tr>
					            ...
					            <b>49.&nbsp;</b>
					            <span title="dkih_49">Ident. af oplag</span></td>
					            <span style="position:absolute; left:800px; top:150px; width:250px; height:240px;" id="49_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					            ...
					            <span title="dkih_brut">Bruttovægt</span></td>
				            ...
				            <tr>
					            ...
					            <b>6.&nbsp;</b>
					            <span title="dkih_06">Kolli i alt</span></td>
					        ...
					        <tr>
				 				...
				 				&nbsp;<b>12.&nbsp;Værdioplysninger&nbsp;</b></td>
				 				<span style="position:absolute; left:800px; top:850px; width:250px; height:320px;" id="dkih_12_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					        ...
					        <tr>
					            ...
					            <span title="dkih_s17"><b>S17.</b>&nbsp;Lastningssted</span></td>
					            <span style="position:absolute; left:800px; top:850px; width:250px; height:320px;" id="s17_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					        ...
					        <tr>
					            ...
					            <span title="dkih_s18"><b>S18.</b>&nbsp;Losningssted</span></td>
					            <span style="position:absolute; left:800px; top:850px; width:250px; height:320px;" id="s18_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					        ...
					        <tr>
					            ...
					            <span style="position:absolute; left:800px; top:850px; width:250px; height:320px;" id="s28_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					        ...
					        <tr>
					            ...
					            <span style="position:absolute; left:800px; top:850px; width:250px; height:320px;" id="s32_info" class="popupWithInputText"  >
					           		<div class="text11" align="left">
					        ...
					        <tr>
					 			...
					 			<td class="text12" align="left" >
				 					...
				 					<div class="text11" style="position:relative; align="left">
					 					<span style="position:absolute; left:0px; top:0px;" id="recalculationFlag_info" class="popupWithInputText"  >
							 		...
							 		<td>
								 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
									        ...
									        <tr>
									            ...
									            <td class="text12" align="left" >&nbsp;&nbsp;
									            <span title="dkih_trna">Navn</span>
									            <img id="imgTranportorSearch" style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" onClick="showPop('searchCustomerDialog20');">
									            	<%-- ======================================================== --%>
									            	<%-- Here we have the search Deklarant [Customer] popup window --%>
									            	<%-- ======================================================== --%>
									            	<span style="position:absolute; left:500px; top:1100px; width:300px; height:250px;" id="searchCustomerDialog20" class="popupWithInputText"  >
										           		<div class="text10" align="left">
										           			<table>
										           				<tr>
																	<td class="text11">&nbsp;Kundenummer</td>
																	<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_trkn" id="search_dkih_trkn" size="18" maxlength="8" value=''></td>
																</tr>
											           			<tr>
																	<td class="text11">&nbsp;Navn</td>
																	<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_trna" id="search_dkih_trna" size="18" maxlength="35" value=''></td>
																</tr>
											           			<tr>
											           				<td class="text11">&nbsp;</td>
												           			<td align="right">&nbsp;<button name="searchCustomer20" class="buttonGray" type="button" onClick="searchTransportorOwnWindow()"><spring:message code="systema.skat.import.search"/></button></td>
												           		</tr>
												           		<tr height="4"><td ></td></tr>
												           		<tr>
											           				<td class="text11">&nbsp;Udvalg</td>
												           		...
												           		<tr>
																	<td colspan="2">&nbsp;
																		<select class="text11" id="transportorList" name="transportorList" size="3" onDblClick="hidePop('searchCustomerDialog20');">
						 													<option selected value="">-vælg-</option>
						 							 					</select>
																	</td>
																</tr>
															...
															<table width="30%" align="left" border="0">
																<tr align="left" >
																	<td >&nbsp;<button name="searchCustomer20CloseOk" id="searchCustomer20CloseOk" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog20');"><spring:message code="systema.skat.import.ok"/></button></td>
																	<td >&nbsp;<button name="searchCustomer20CloseCancel" id="searchCustomer20CloseCancel" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog20');"><spring:message code="systema.skat.import.cancel"/></button></td>
																</tr>
															</table>
														</div>
													</span>	
			 				...
			 				<table width="100%" align="left" class="formFrameHeader" border="0" cellspacing="0" cellpadding="0">
						 		<tr height="18px">
						 			<td class="text12White">
				 						...
				 						<span style="position:absolute; left:800px; top:1000px; width:250px; height:320px;" id="underettes_info" class="popupWithInputText"  >
							           		<div class="text11" align="left">
							           			<b>Underettes</b>
							           			<br/><br/>
							           			Todo
							 		...
							 		<td>
								 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
									        ...
									        <tr>
									            ...
									            <img id="imgUnderettesSearch" style="cursor:pointer;" src="resources/images/find.png" border="0" alt="search" onClick="showPop('searchCustomerDialog30');">
									            	<%-- ======================================================== --%>
									            	<%-- Here we have the search Deklarant [Customer] popup window --%>
									            	<%-- ======================================================== --%>
									            	<span style="position:absolute; left:500px; top:1400px; width:300px; height:250px;" id="searchCustomerDialog30" class="popupWithInputText"  >
										           		<div class="text10" align="left">
										           			<table>
										           				<tr>
																	<td class="text11">&nbsp;Kundenummer</td>
																	<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_nikn" id="search_dkih_nikn" size="18" maxlength="8" value=''></td>
																</tr>
											           			<tr>
																	<td class="text11">&nbsp;Navn</td>
																	<td class="text11">&nbsp;<input type="text" class="inputText" name="search_dkih_nina" id="search_dkih_nina" size="18" maxlength="35" value=''></td>
																</tr>
											           			<tr>
											           				<td class="text11">&nbsp;</td>
												           			<td align="right">&nbsp;<button name="searchCustomer20" class="buttonGray" type="button" onClick="searchUnderettesOwnWindow()"><spring:message code="systema.skat.import.search"/></button></td>
												           		</tr>
												           		<tr height="4"><td ></td></tr>
												           		<tr>
											           				<td class="text11">&nbsp;Udvalg</td>
												           		...
												           		<tr>
																	<td colspan="2">&nbsp;
																		<select class="text11" id="underettesList" name="underettesList" size="3" onDblClick="hidePop('searchCustomerDialog30');">
						 													<option selected value="">-vælg-</option>
						 							 					</select>
																	</td>
																</tr>
															...
															<table width="30%" align="left" border="0">
																<tr align="left" >
																	<td >&nbsp;<button name="searchCustomer30CloseOk" id="searchCustomer30CloseOk" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog30');"><spring:message code="systema.skat.import.ok"/></button></td>
																	<td >&nbsp;<button name="searchCustomer30CloseCancel" id="searchCustomer30CloseCancel" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('searchCustomerDialog30');"><spring:message code="systema.skat.import.cancel"/></button></td>
																</tr>
															</table>
														</div>
													</span>	
						 				...
						 				<table align="left" border="0" cellspacing="0" cellpadding="0">
							 				<tr>
								 				<td class="text12">
								 					...
								 					<span style="position:absolute; left:800px; top:1100px; width:250px; height:200px;" id="beg_fasthold_info" class="popupWithInputText"  >
										           		<div class="text11" align="left">
										           			<b>Begrundelse for fastholdelse</b>
										           			<br/><br/>
							...
							<td width="2">&nbsp;</td>
				 			<td class="text12" >
								...
								<tr>
						 			...
						 			<b>7.</b>&nbsp;
						 			<span title="dkih_07a...dkih_07d"><b>Referencenummer&nbsp;</b></span></td>
						 			<span style="position:absolute; left:800px; top:1100px; width:250px; height:320px;" id="7_info" class="popupWithInputText"  >
						           		<div class="text11" align="left">
							...
							<td colspan="3">
								<table align="left" border="0" cellspacing="0" cellpadding="0">
					 				...
					 				<tr>
						 				...
						 				<span style="position:absolute; left:800px; top:1000px; width:250px; height:320px;" id="toldvardidekl_info" class="popupWithInputText"  >
							           		<div class="text11" align="left">
