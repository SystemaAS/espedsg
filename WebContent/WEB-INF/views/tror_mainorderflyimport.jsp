...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tror_mainorderflyimport.js?ver=${user.versionEspedsg}"></SCRIPT>
		...
		<tr height="25"> 
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a class="text14" onClick="setBlockUI(this);" href="tror_mainorderflyimport_invoice.do?action=doFetch&heavd=${model.record.heavd}&heopd=${model.record.heopd}" > 	
			 			...
			 			<c:choose>
				 			<c:when test="${not empty model.record.heopd}">
					 			<td align="left" class="text14White">
									...
									&nbsp;&nbsp;&nbsp;<b><spring:message code="systema.tror.order.suborder.flyimport"/></b>
				 				</td >
			 				</c:when>
			 				<c:otherwise>
								<td align="left" class="text14White">
									...
									<c:if test="${empty model.record.heopd}">
										<table class="tableBorderWithRoundCornersLightGray" border="0">
							 			<tr>
							 				...
							 				<td class="text14" ><b><spring:message code="systema.tror.order.suborder.flyimport"/></b></td>
