...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/skatmaintenancenctsexport_dkx001r.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<table width="100%" class="text11" cellspacing="0" border="0" cellpadding="0">
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkSadMaintExportKoder" tabindex=-1 style="display:block;" href="skatmaintenancenctsexport_kodergate.do?id=DKXKODF">
					...
					<td width="30%" valign="bottom" class="tab" align="center" nowrap>
						<font class="tabLink">&nbsp;Kodetype&nbsp;<font class="text12">${model.tkunik}&nbsp;${model.legend}</font></font>&nbsp;
						<img style="vertical-align: middle;"  src="resources/images/list.gif" border="0" alt="general list">
					</td>
		...
		<%-- space separator --%>
			...
			<tr >
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="skatmaintenancenctsexport_dkx001r_edit.do" name="formRecord" id="formRecord" method="POST" >
