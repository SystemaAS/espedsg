	...
	<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25">
			...
			<td width="18%" valign="bottom" class="tab" align="center" nowrap>
				...
				<font class="tabLink">&nbsp;<spring:message code="systema.transportdisp.update.ourref.tab"/><font class="text12MediumBlue">&nbsp;${model.record.heavd}/${model.record.heopd}</font></font>
			</td>
					...
					<table style="width:99%;" align="left" class="formFrame" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<table border="0">
							 	<tr>
							 		...
							 		<td class="text11">
						 		 	...
						 		 	<td class="text11">&nbsp;&nbsp;
						 				...
						 				<span title="trknfa"><font class="text12RedBold" >*</font><spring:message code="systema.transportdisp.orders.form.update.label.principalNo"/>&nbsp;</span>
					 				...
					 				<td class="text11">&nbsp;&nbsp;
						 				...
						 				<span title="henaa"><font class="text12RedBold" >*</font><spring:message code="systema.transportdisp.orders.form.update.label.principalName"/></span>
						 			</td>
						 			<td>	
				 				...
				 				<tr>	
									<td class="text11"><img onMouseOver="showPop('oType_info');" onMouseOut="hidePop('oType_info');"style="vertical-align:bottom;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
										<span title="heot"><font class="text12RedBold" >*</font><spring:message code="systema.transportdisp.orders.form.update.label.orderType"/>&nbsp;</span>
						 				<div class="text11" style="position: relative;" align="left">
									...
									<td class="text11">&nbsp;&nbsp;
										<img onMouseOver="showPop('incoterms_info');" onMouseOut="hidePop('incoterms_info');"style="vertical-align:bottom;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
						 				<span title="hefr"><font class="text12RedBold" >*</font><spring:message code="systema.transportdisp.orders.form.update.label.incoterms"/>&nbsp;</span>
						 				<div class="text11" style="position: relative;" align="left">
						 			...
						 			<td align="right" class="text11">&nbsp;<span title="hebodt"><spring:message code="systema.transportdisp.orders.form.update.label.booking.date"/></span></td>
						 			<td class="text11">
					 					<input type="text" class="inputTextMediumBlue11" name="hebodt" id="hebodt" size="9" maxlength="8" value="${model.record.hebodt}">
						...
						<tr>
							...
							<table class="tableBorderWithRoundCornersLightGray">
								<tr>
									<td class="text12Bold"><spring:message code="systema.transportdisp.orders.form.update.label.shippingDates"/></td>
									<td class="text11">&nbsp;<font class="text12RedBold" >*</font><span title="wsetdd/wsetdk"><spring:message code="systema.transportdisp.orders.form.update.label.shippingDates.etd"/></span></td>
									<td class="text11">
									...
									<td class="text11">&nbsp;<span title="wsatdd/wsatdk"><spring:message code="systema.transportdisp.orders.form.update.label.shippingDates.atd"/></span></td>
									<td class="text11">
									...
									<td class="text11"><input readonly tabindex=-1 type="text" class="inputTextReadOnly" name="wsatdk" id="wsatdk" size="4" maxlength="4" value="${model.record.wsatdk}"></td>
								</tr>
							</table>
							</td>
							<td >
							<table class="tableBorderWithRoundCornersLightGray">
								<tr>
									<td class="text12Bold"><spring:message code="systema.transportdisp.orders.form.update.label.arrivalDates"/></td>
									<td class="text11">&nbsp;<font class="text12RedBold" >*</font><span title="wsetad/wsetak"><spring:message code="systema.transportdisp.orders.form.update.label.arrivalDates.eta"/></span></td>
									<td class="text11">
									...
									<td class="text11">&nbsp;<span title="wsatad/wsatak"><spring:message code="systema.transportdisp.orders.form.update.label.arrivalDates.ata"/></span></td>
									<td class="text11">
									...
									<td class="text11"><input readonly tabindex=-1 type="text" class="inputTextReadOnly" name="wsatak" id="wsatak" size="4" maxlength="4" value="${model.record.wsatak}"></td>
								</tr>
							</table>
							</td>		
						</tr>
				 				...
				 				<tr>
				 					...
				 					<table class="tableBorderWithRoundCornersLightGray">
						 				...
						 				<tr>	
						 					...
						 					<td class="text11" ><input onKeyPress="return numberKey(event)" type="text" class="inputTextMediumBlueUPPERCASE" name="heans" id="heans" size="1" maxlength="1" value="${model.record.heans}"></td>
					 					</tr>
									</table>
									</td>				 				
					 			</tr>	
				 				...
				 				<tr>
				 					...
				 					<table class="tableBorderWithRoundCornersLightGray">
						 				...
						 				<tr>	
						 					...
						 					<td class="text11" ><input onKeyPress="return numberKey(event)" type="text" class="inputTextMediumBlueUPPERCASE" name="heank" id="heank" size="1" maxlength="1" value="${model.record.heank}"></td>
					 					</tr>
									</table>
									</td>				 				
					 			</tr>								 
				 		...
				 		<tr>
								...
								<table>
							 	...
							 	<tr>	
						 			<td class="text11">
						 				...
						 				<font class="text12RedBold" >*</font><span title="helka/hesdf/OWNwppns1"><spring:message code="systema.transportdisp.orders.form.update.label.from"/>&nbsp;</span>
						 				<div class="text11" style="position: relative;" align="left">
					 			...
					 			<tr>	
						 			<td class="text11">
						 				...
						 				<font class="text12RedBold" >*</font><span title="hetri/hesdt/OWNwppns2"><spring:message code="systema.transportdisp.orders.form.update.label.to"/></span>
						 				<div class="text11" style="position: relative;" align="left">
							...
							<table >
						 		<tr>	
									...
									<td nowrap class="text11">
										<input onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue11" size="15" maxlength="14" name="trfrab" id="trfrab" value="${model.record.trfrab}">
									...
									<td nowrap class="text11">&nbsp;
						 			...
						 			<td class="text11">
						 				<input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" name="trmva" id="trmva" value="${model.record.trmva}">
						 			</td>									
						 			<td nowrap class="text11">&nbsp;
						 			...
						 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hekdpl" id="hekdpl" value="${model.record.hekdpl}"></td>									
						 		</tr>
						 		<tr>	
						 			<td nowrap class="text11">&nbsp;
						 			...
						 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="3" name="hevalt" id="hevalt" value="${model.record.hevalt}">&nbsp;</td>									
						 			<td nowrap class="text11">&nbsp;
						 			...
						 			<td class="text11">
						 				...
						 				<input onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue11UPPERCASE" size="5" maxlength="4" name="hevalp" id="hevalp" value="${formattedPercentHevalp}">&nbsp;
						 			...
						 			<td class="text11" colspan="3" nowrap>
						 				<input type="text" class="inputTextMediumBlue11UPPERCASE tableCell" size="1" maxlength="1" name="hestn1" id="hestn1" value="${model.record.hestn1}">
						 				<input type="text" class="inputTextMediumBlue11UPPERCASE tableCell" size="1" maxlength="1" name="hestn2" id="hestn2" value="${model.record.hestn2}">
						 				<input type="text" class="inputTextMediumBlue11UPPERCASE tableCell" size="1" maxlength="1" name="hestn3" id="hestn3" value="${model.record.hestn3}">
						 				<input type="text" class="inputTextMediumBlue11UPPERCASE tableCell" size="1" maxlength="1" name="hestn4" id="hestn4" value="${model.record.hestn4}">
						 				<input type="text" class="inputTextMediumBlue11UPPERCASE tableCell" size="1" maxlength="1" name="hestn5" id="hestn5" value="${model.record.hestn5}">
						 		...
						 		<tr>	
						 			...
						 			<td class="text11" colspan="3"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="30" maxlength="15" name="hegn" id="hegn" value="${model.record.hegn}"></td>									
									<td class="text11">&nbsp;
						 			...
						 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="7" name="hepos1" id="hepos1" value="${model.record.hepos1}"></td>									
									<td class="text11">&nbsp;
										<img onMouseOver="showPop('pos1_info');" onMouseOut="hidePop('pos1_info');"style="vertical-align:bottom;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
						 			...
						 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="4" name="hepos2" id="hepos2" value="${model.record.hepos2}">&nbsp;&nbsp;</td>
								</tr>
									...
									<table>
						 			<tr>		
										<td nowrap class="text11">&nbsp;
							 			...
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hepk3" id="hepk3" value="${model.record.hepk3}"></td>
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hepk5" id="hepk5" value="${model.record.hepk5}"></td>
							 			...
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hepk4" id="hepk4" value="${model.record.hepk4}"></td>
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hepk6" id="hepk6" value="${model.record.hepk6}"></td>
							 			<td class="text11">&nbsp;
							 				<span title="hepk7"><spring:message code="systema.transportdisp.orders.form.update.label.billOfLading"/></span></td>
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hepk7" id="hepk7" value="${model.record.hepk7}"></td>
							            ...
							            <td class="text11">
							 			...
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" name="w2kde" id="w2kde" size="1" maxlength="1" value="${model.record.w2kde}"></td>	
							 			 --%>
							 			<td nowrap class="text11">&nbsp;
							 			...
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="1" maxlength="1" name="hepk2" id="hepk2" value="${model.record.hepk2}"></td>
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" size="3" maxlength="1" name="hentvs" id="hentvs" value="${model.record.hentvs}"></td>	
							 			<td nowrap class="text11">&nbsp;
							 			...
							 			<td class="text11"><input type="text" class="inputTextMediumBlue11UPPERCASE" name="hepk8" id="hepk8" size="1" maxlength="1" value="${model.record.hepk8}"></td>
						 			</tr>
						 			</table>
						 			</td>
						 		</tr>
							...
							<td colspan="2" valign="top" style="width:100%;" >
								...
								<tr class="tableRow">	
									...
									<td align="left" class="tableHeaderField11">
										<input type="text" class="inputTextMediumBlue10" name="hegm1" id="hegm1" size="6" maxlength="35" value="${model.record.hegm1}">
									</td>
						 			<td align="right" class="tableHeaderField11">
						 				<input onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue10MandatoryField" style="text-align:right;" name="hent" id="hent" size="8" maxlength="7" value="${model.record.hent}">
						 			</td>
						 			<td width="7%" align="left" class="tableHeaderField11">&nbsp;</td>
						 			<td width="7%" align="left" class="tableHeaderField11">
						 				<input type="text" class="inputTextMediumBlue10MandatoryFieldUPPERCASE" style="text-align:left;" name="hevs1" id="hevs1" size="10" maxlength="25" value="${model.record.hevs1}">
						 			</td>
						 			<td width="7%" align="right" class="tableHeaderField11">
						 				<input onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue10MandatoryField" style="text-align:right;" name="hevkt" id="hevkt" size="8" maxlength="9" value="${model.record.hevkt}">
						 			</td>
						 			<td align="left" class="tableHeaderField11">&nbsp;</td>
						 			<td align="left" class="tableHeaderField11">&nbsp;</td>
						 			<td align="left" class="tableHeaderField11">&nbsp;</td>
						 			<td align="right" class="tableHeaderField11"><span title="hem3">&nbsp;</span>
						 				<input onBlur="checkHem3(this);" onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue10Bold" style="text-align:right;" name="hem3" id="hem3" size="5" maxlength="8" value="${model.record.hem3}">
					 				</td>
						 			<td align="right" class="tableHeaderField11"><span title="helm">&nbsp;</span>
						 				<input onBlur="checkHelm(this);" onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue10Bold" style="text-align:right;" name="helm" id="helm" size="5" maxlength="5" value="${model.record.helm}">
					 				</td>
					...
					<table style="width:99%" class="formFrame" > 		
			 		<tr>
			 			<td valign="top" align="left" style="width:50%" >
				 			<table>
								<tr>
						 			<td class="text12"><spring:message code="systema.transportdisp.orders.form.update.label.messageConsignee"/></td>
						 			<td class="text11">
								...
								<tr>
						 			<td class="text12"><spring:message code="systema.transportdisp.orders.form.update.label.messageCarrier"/></td>
						 			<td class="text11">
				 				...
				 				<tr>
						 			<td class="text12"><spring:message code="systema.transportdisp.orders.form.update.label.messageInternal"/></td>
						 			<td class="text11">
						 				<textarea class="text11UPPERCASE" id="messageNoteInternal" name="messageNoteInternal" limit='70,2' cols="75" rows="2">${model.record.messageNoteInternal}</textarea>
					 				</td>
				 				</tr>
			 				</table>
		 				</td>
