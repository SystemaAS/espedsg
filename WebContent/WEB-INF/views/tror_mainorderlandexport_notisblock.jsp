...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tror_mainorderlandexport_notisblock.js?ver=${user.versionEspedsg}"></SCRIPT>
						...
						<tr >
							...
							<form name="createNewItemLine" id="createNewItemLine" method="post" action="editNotisblock.do">
								<%--Required key parameters --%>
							 	...
							 	<input type="hidden" name="subsys" id="subsys" value='tror_le'/>
