							...
							<td class="ownScrollableSubWindow" style="width:100%; height:20em;"> 
								...
								<%-- <table id="tblInvoices" class="display compact cell-border" >  --%>
									...
									<tr style="background-color:#DDDDDD" class="tableHeaderField" height="23" valign="left">
										...
										<c:if test="${empty recordOrderTrorFly.hest || recordOrderTrorFly.hest == 'U' || recordOrderTrorFly.hest == 'O' || recordOrderTrorFly.hest == 'F' }">
					 		...
					 		<td>
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
			            				...
			            				<c:choose>	
											<c:when test="${empty recordOrderTrorFly.hest || recordOrderTrorFly.hest == 'U' || recordOrderTrorFly.hest == 'O' || recordOrderTrorFly.hest == 'F' }">
												<td align="center">
