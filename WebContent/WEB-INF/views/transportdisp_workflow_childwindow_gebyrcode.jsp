...
<!-- =====================end header ====================================-->
	...
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<tr>
			<td colspan="3" class="text14Bold">&nbsp;<spring:message code="systema.transportdisp.orders.invoice.form.label.gebyrcode.title"/></td>
		</tr>
          	...
          	<%-- =====================================================  --%>
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%">
					...
					<td>
						<table>
						<tr>
							<td class="text11">&nbsp;<spring:message code="systema.transportdisp.orders.invoice.form.label.gebyrcode.code"/></td>
							<td class="text11">&nbsp;<input type="text" class="inputText" name="kode" id="kode" size="21" maxlength="20" value="${model.container.kode}"></td>
							<td class="text11">&nbsp;<spring:message code="systema.transportdisp.orders.invoice.form.label.gebyrcode.desc"/></td>
					...
					<table id="gebyrcodeList" class="display compact cell-border" width="100%">
						...
						<tr style="background-color:#EEEEEE">
						    <th class="text11">&nbsp;<spring:message code="systema.transportdisp.orders.invoice.form.label.gebyrcode.code"/>&nbsp;</th>   
		                    <th class="text11">&nbsp;<spring:message code="systema.transportdisp.orders.invoice.form.label.gebyrcode.desc"/>&nbsp;</th>
		                </tr> 
		                </thead>
