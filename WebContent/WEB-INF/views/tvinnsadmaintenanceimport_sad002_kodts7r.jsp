			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tab" align="center">
						<font class="tabLink">&nbsp;SAD002 / KODTS7</font>&nbsp;
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text12">&nbsp;${record.ks7vf}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text12">&nbsp;${record.ks7ftx}&nbsp;</font></td>
	 	    ...
	 	    <tr >
				...
				<form action="tvinnsadmaintenanceimport_sad002_kodts7r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="60%" cellspacing="1" border="0" align="left">
			    	    <tr>
						<td class="text12" title="KS7VF">&nbsp;<font class="text14RedBold" >*</font>Kode</td>
						<td class="text12" title="KS7FTX">&nbsp;<font class="text14RedBold" >*</font>Fritekst</td>
