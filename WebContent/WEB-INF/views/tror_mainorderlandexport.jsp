...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tror_mainorderlandexport.js?ver=${user.versionEspedsg}"></SCRIPT>
...
<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25"> 
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a class="text14" onClick="setBlockUI(this);" href="tror_mainorderlandexport_invoice.do?action=doFetch&heavd=${model.record.heavd}&heopd=${model.record.heopd}" > 	
					...
					<c:if test="${model.record.hepk1 == 'J' || model.record.hepk1 == 'P'}">
						<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
						<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
							<a class="text14" onClick="setBlockUI(this);" href="tror_mainorderlandexport_freightbill_edit.do?dfavd=${model.record.heavd}&sign=${model.record.hesg}&dfopd=${model.record.heopd}">
	...
	<%-- ------------------------------- --%>
					...
					<span style="position:absolute; left:1500px; top:160px; width:550px; height:800px;" id="economyMatrixInfo" class="popupFloating"  >
		           		...
		           		<table align="left" class="popupFloatingWithRoundCorners3D">
							...
							<form name="uploadFileForm" id="uploadFileForm" method="post" enctype="multipart/form-data">
								...
								<input type="hidden" name="callerModule" id="callerModule" value='trorLandexport'>
		...
		<tr>
		<td>
			<form action="tror_mainorderlandexport.do" name="trorOrderForm" id="trorOrderForm" method="post">
										...
										<table class="tableBorderWithRoundCornersLightGray" border="0">
							 			<tr>
							 				...
							 				<td class="text14" >
							 					...
							 					<a href="javascript:void(0);" onClick="window.open('tror_mainorder_childwindow_avd.do?action=doFind&ctype=tror_landexport','customerWin','top=300px,left=150px,height=600px,width=800px,scrollbars=no,status=no,location=no')">
								...
								<tr>
									...
									<tr>
						 				<td class="text12">
						 					...
						 					<a href="javascript:void(0);" onClick="window.open('tror_mainorder_childwindow_oppdragstype.do?action=doFind&ctype=landexport','opptypeWin','top=300px,left=150px,height=600px,width=800px,scrollbars=no,status=no,location=no')">
										...
										<td class="text12">
											...
											<a href="javascript:void(0);" onClick="window.open('tror_mainorder_childwindow_incoterms.do?action=doFind&ctype=landexport','incotermsWin','top=300px,left=150px,height=600px,width=800px,scrollbars=no,status=no,location=no')">
										...
										<td class="text12">
											...
											<a href="javascript:void(0);" onClick="window.open('tror_mainorder_childwindow_productcodes.do?action=doFind&ctype=landexport','customerWin','top=300px,left=150px,height=600px,width=800px,scrollbars=no,status=no,location=no')">
												...
												<tr class="tableHeaderField10" >
										 		...
										 		<tr class="tableRow">
									 				...
									 				<td align="center" class="tableCell" nowrap>
														...
														<a href="javascript:void(0);" onClick="window.open('tror_mainorder_childwindow_unitcodes.do?action=doFind&ctype=tror_landexport_e1','unitWin','top=300px,left=150px,height=600px,width=800px,scrollbars=no,status=no,location=no')">
			 ...
			 <tr>
				<td>
					<div id="dialogUpdateStatus" title="Dialog">
						 	<form action="tror_mainorderlandexport_updateStatus.do" name="updateStatusForm" id="updateStatusForm" >
