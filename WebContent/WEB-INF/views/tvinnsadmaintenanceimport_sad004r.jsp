...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadmaintenanceimport_sad004r.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<%-- space separator --%>
			...
			<tr >
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="tvinnsadmaintenanceimport_sad004r_edit.do" name="formRecord" id="formRecord" method="POST" >
