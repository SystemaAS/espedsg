		...
		<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
			...
			<tr height="25"> 
				...
				<td width="15%" valign="bottom" class="tab" align="center" nowrap>
					<font class="tabLink">&nbsp;<spring:message code="systema.ncts.export.logging.tab"/></font>
			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					<tr class="tableHeaderField" height="20" valign="left">
	                    ...
	                    <td class="tableHeaderFieldFirst">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.topicNr"/>&nbsp;</td>
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.messageNr"/>&nbsp;</td> 
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.type"/>&nbsp;</td> 
	                      
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.date"/>&nbsp;</td>
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.time"/>&nbsp;</td>
	                    <td class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.text"/>&nbsp;</td>
	               </tr>     
		               ...
		               <td class="tableCell" >&nbsp;
		               		<a href="ncts_export_renderEdifact.do?fp=${record.wurl}" target="_new" >
		               ...
		               <td class="tableCell" >&nbsp;${record.wtxt}
		               		<c:if test="${record.wmore == 'X'}">
		               			&nbsp;&nbsp;
		               			<a href="ncts_export_renderLargeText.do?fmn=${record.mmn}" target="_blank" onClick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=500'); return false;">
