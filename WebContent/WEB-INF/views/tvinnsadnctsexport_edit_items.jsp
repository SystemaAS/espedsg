           	...
           	<tr>
				<td>
					<table width="100%" cellspacing="0" border="0" cellpadding="0">
										           	...
										           	<tr>	
														...
														<table width="95%" cellspacing="0" border="0" cellpadding="0">
															<tr class="tableHeaderField" height="20" valign="left">
											                    ...
											                    <td class="tableHeaderField">&nbsp;Dekl&nbsp;</td>
											                    <td class="tableHeaderField">&nbsp;Avs.land&nbsp;</td>
											                    <td class="tableHeaderField">&nbsp;Best.land&nbsp;</td>
											                    <td class="tableHeaderField">&nbsp;Dok.type&nbsp;</td>
											                    <td class="tableHeaderField">&nbsp;Bruttovekt&nbsp;</td>
											                    <td class="tableHeaderField">&nbsp;Nettovekt&nbsp;</td>
											                    <td class="tableHeaderField">&nbsp;Kolliant.(&Sigma;)</td>
											                    <td class="tableHeaderField">&nbsp;Stk.(&Sigma;)</td>
						...
						<tr>
							<td valign="top" class="ownScrollableSubWindow" style="width:1050px; height:10em;">
								<table width="100%" cellspacing="0" border="0" cellpadding="0">
									<tr class="tableHeaderField" height="20" valign="left">
									    <td class="tableHeaderFieldFirst">&nbsp;Linjenr.&nbsp;</td> 
									    <td class="tableHeaderField">&nbsp;Varenr.&nbsp;</td>   
