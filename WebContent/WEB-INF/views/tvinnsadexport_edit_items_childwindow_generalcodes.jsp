...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadexport_edit_items_childwindow_generalcodes.js?ver=${user.versionEspedsg}"></SCRIPT>
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<table id="generalCodeList" class="display compact cell-border" width="100%" >
		                ...
		                <c:forEach var="record" items="${model.generalCodeList}" varStatus="counter">    
			               ...
			               <c:choose>           
			                   <c:when test="${model.callerType=='svavts'}">
