...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadnctsexport_edit_items_childwindow_tolltariff.js?ver=${user.versionEspedsg}"></SCRIPT>
	...
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						<table>
						<form name="tvinnsadImportTolltariffForm" id="tvinnsadImportTolltariffForm" action="tvinnsadnctsexport_edit_items_childwindow_tolltariff.do?action=doInit" method="post">
						<tr>
