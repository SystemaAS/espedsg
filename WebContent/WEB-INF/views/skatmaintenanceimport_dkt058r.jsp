						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil fjerne denne?')" tabindex=-1 href="skatmaintenanceimport_dkt058r_edit.do?action=doDelete&id=${model.dbTable}&dkse_knr=${record.dkse_knr}&dkse_331=${record.dkse_331}">
				...
				<form action="skatmaintenanceimport_dkt058r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="80%" cellspacing="1" border="0" align="left">
			    	    <tr>
							...
							<td class="text12" title="DKSE_34">&nbsp;Landkode</td>
							<td class="text12" title="DKSE_4421">&nbsp;Certifikatkode</td>
							<td class="text12" title="DKSE_442A">&nbsp;Nummer</td>
						</tr>
						<tr>
						<td ><input onKeyPress="return amountKey(event)" type="text" required oninvalid="this.setCustomValidity('Obligatoriskt')" oninput="setCustomValidity('')" class="inputTextMediumBlueMandatoryField" name="dkse_knr" id="dkse_knr" size="10" maxlength="8" value='${model.record.dkse_knr}'></td>
						<td ><input onKeyPress="return amountKey(event)" type="text" required oninvalid="this.setCustomValidity('Obligatoriskt')" oninput="setCustomValidity('')" class="inputTextMediumBlueMandatoryField" name="dkse_331" id="dkse_331" size="11" maxlength="10" value='${model.record.dkse_331}'></td>
						<td ><input onKeyPress="return numberKey(event)" type="text" class="inputTextMediumBlue" name="dkse_34" id="dkse_34" size="3" maxlength="2" value='${model.record.dkse_34}'></td>
						<td ><input onKeyPress="return numberKey(event)" type="text" class="inputTextMediumBlue" name="dkse_4421" id="dkse_4421" size="5" maxlength="4" value='${model.record.dkse_4421}'></td>
