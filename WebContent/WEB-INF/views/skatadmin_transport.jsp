...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/skatadmin_transport.js?ver=${user.versionEspedsg}"></SCRIPT>	
	...
	<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25"> 
			<td width="20%" valign="bottom" class="tab" align="center" nowrap>
				<font class="tabLink">&nbsp;<spring:message code="systema.skat.admin.transport.list.tab"/></font>
...
<tr>
	...
	<%-- search filter component --%>
 		...
 		<table width="100%" class="tabThinBorderWhite" border="0" cellspacing="0" cellpadding="0">
 	        ...
 	        <form name="skatAdminTransportSearchForm" id="skatAdminTransportSearchForm" action="skatadmin_transport?action=doFind" method="post" >
 	        <tr>	
 	        		<td class="text12" align="left" >&nbsp;&nbsp;&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.avd"/></td>
                <td class="text12" align="left" >&nbsp;&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.sign"/></td>
                <td class="text12" align="left" >&nbsp;&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.transportuppdrag"/></td>
                <td class="text12" align="left" >&nbsp;&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.sender"/></td>
                <td class="text12" align="left" >&nbsp;&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.receiver"/></td>
                <td class="text12" align="left" >&nbsp;&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.datum"/></td>
                <td>&nbsp;</td>
			</tr>
 	        <tr>
			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					<tr class="tableHeaderField" height="20" valign="left">
	                    <td class="tableHeaderFieldFirst" align="left" >&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.avd"/></td>
                			<td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.sign"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.transportuppdrag"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.sender"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.receiver"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.skat.admin.transport.list.search.label.datum"/></td>
	                </tr>     
