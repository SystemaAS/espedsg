...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/skatmaintenancefelles_dkt056r.js?ver=${user.versionEspedsg}"></SCRIPT>	
			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="25%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Sagsbehandler</font>&nbsp;<font class="text12">DKT056 / DKTHA</font>&nbsp;
						<a id="alinkRecordId_${counter.count}" onClick="setBlockUI(this);" href="skatmaintenancefelles_dkt056r.do?id=${model.dbTable}">
