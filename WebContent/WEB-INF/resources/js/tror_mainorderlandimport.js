  ...
  jq(function() {
	  	...
	  	jq('#trackAndTraceButton').click(function() {
	  		window.open('tror_mainorderlandimport_ttrace_general.do?avd='+ jq('#heavd').val() + '&opd=' + jq('#heopd').val() + "&tur=" + jq('#hepro').val(), 'ttraceGeneralWin','top=120px,left=100px,height=800px,width=900px,scrollbars=no,status=no,location=no');
	  	})
  });
