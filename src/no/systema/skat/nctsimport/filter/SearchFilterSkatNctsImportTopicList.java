 ...
 * 
 */
package no.systema.skat.nctsimport.filter;
 ...
 * @date   Apr 23, 2014
 */
public class SearchFilterSkatNctsImportTopicList {
	private static final Logger logger = Logger.getLogger(SearchFilterSkatNctsImportTopicList.class.getName());
