 ...
 *
 */
public class JsonSkatCodeContainer {
	...
	private Collection<JsonSkatCodeRecord> kodlista = null;
	public void setKodlista(Collection<JsonSkatCodeRecord> value){ this.kodlista = value;}
	public Collection<JsonSkatCodeRecord> getKodlista(){ return this.kodlista; }
