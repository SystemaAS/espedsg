 ...
 *
 */
public class MaintSkatImportDkt057rValidator implements Validator {
	private static final Logger logger = Logger.getLogger(MaintSkatImportDkt057rValidator.class.getName());
