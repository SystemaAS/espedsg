...
@Scope("session")
public class MaintTdsNctsExportKoderSvx001rController {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = Logger.getLogger(MaintTdsNctsExportKoderSvx001rController.class.getName());
