package no.systema.tds.nctsimport.controller.view;
...
@Controller
public class NctsImportUnloadingItemListViewController {
	private static final Logger logger = Logger.getLogger(NctsImportUnloadingItemListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tdsNctsImportUnloadingItemListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "tdsNctsImportUnloadingItemListExcelView";
		
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		List<JsonNctsImportSpecificTopicUnloadingItemRecord> itemList = null;
