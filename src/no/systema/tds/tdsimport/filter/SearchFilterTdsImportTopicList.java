 ...
 * 
 */
package no.systema.tds.tdsimport.filter;
 ...
 * @date 	Sep 2, 2013
 */
public class SearchFilterTdsImportTopicList {
	private static final Logger logger = Logger.getLogger(SearchFilterTdsImportTopicList.class.getName());
