package no.systema.tds.tdsimport.controller.view;
...
@Controller
public class TdsImportItemListViewController {
	private static final Logger logger = Logger.getLogger(TdsImportItemListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tdsImportItemListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "tdsImportItemListExcelView";
		
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		List<JsonTdsImportSpecificTopicItemRecord> itemList = null;
