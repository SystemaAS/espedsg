package no.systema.tds.tdsexport.controller.view;
...
@Controller
public class TdsExportItemListViewController {
	private static final Logger logger = Logger.getLogger(TdsExportItemListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tdsExportItemListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "tdsExportItemListExcelView";
		
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		List<JsonTdsExportSpecificTopicItemRecord> itemList = null;
