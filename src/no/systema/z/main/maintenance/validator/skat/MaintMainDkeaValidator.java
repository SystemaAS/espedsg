...
public class MaintMainDkeaValidator implements Validator {
	private static final Logger logger = Logger.getLogger(MaintMainDkeaValidator.class.getName());
	...
	public void validate(Object obj, Errors errors) { 
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "dkea_syop", "", "Angivelsesnr er obligatorisk"); 
