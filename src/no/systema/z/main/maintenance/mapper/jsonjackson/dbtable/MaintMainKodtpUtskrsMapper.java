 ...
 * 
 */
public class MaintMainKodtpUtskrsMapper {
	...
	public JsonMaintMainKodtpUtskrsContainer getContainer(String utfPayload) throws Exception{
		...
		JsonMaintMainKodtpUtskrsContainer container = mapper.readValue(utfPayload.getBytes(), JsonMaintMainKodtpUtskrsContainer.class); 
