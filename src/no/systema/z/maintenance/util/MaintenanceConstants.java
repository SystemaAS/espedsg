 ...
 * 
 */
package no.systema.z.maintenance.util;
...
public final class MaintenanceConstants {
	...
	//session constants
	public static final String ACTIVE_URL_RPG_MAINTENANCE = "activeUrlRPG_Maintenance";
	public static final String ACTIVE_URL_RPG_UPDATE_MAINTENANCE = "activeUrlRPGUpdate_Maintenance";
	public static final String ACTIVE_URL_RPG_FETCH_ITEM_MAINTENANCE = "activeUrlRPGFetchItem_Maintenance"; //Ajax
