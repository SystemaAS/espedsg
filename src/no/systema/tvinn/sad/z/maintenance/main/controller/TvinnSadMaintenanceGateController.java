package no.systema.tvinn.sad.z.maintenance.main.controller;
...
/**
 * Gateway to the TVINN-Sad Maintenance Application
 * 
 * 
...
public class TvinnSadMaintenanceGateController {
	private static final Logger logger = Logger.getLogger(TvinnSadMaintenanceGateController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tvinnsadmaintenancegate.do", method={RequestMethod.GET, RequestMethod.POST })
	public ModelAndView tvinnsadmaintenancegate(HttpSession session, HttpServletRequest request){
		ModelAndView successView = new ModelAndView("tvinnsadmaintenancegate");
		...
		if(appUser==null){
			...
			logger.info("Inside method: tvinnsadmaintenancegate");
