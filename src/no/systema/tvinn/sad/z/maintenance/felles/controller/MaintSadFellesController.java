...
/**
 * TVINN Maintenance Felles Controller 
 * 
...
@Scope("session")
public class MaintSadFellesController {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = Logger.getLogger(MaintSadFellesController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadmaintenancefelles.do", method=RequestMethod.GET)
	public ModelAndView doSkatImportList(HttpSession session, HttpServletRequest request){
		ModelAndView successView = new ModelAndView("tvinnsadmaintenancefelles");
