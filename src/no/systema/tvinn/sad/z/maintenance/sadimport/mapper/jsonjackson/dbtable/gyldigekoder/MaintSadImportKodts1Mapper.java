 ...
 * 
 */
public class MaintSadImportKodts1Mapper {
	...
	public JsonMaintSadImportKodts1Container getContainer(String utfPayload) throws Exception{
		...
		JsonMaintSadImportKodts1Container container = mapper.readValue(utfPayload.getBytes(), JsonMaintSadImportKodts1Container.class); 
