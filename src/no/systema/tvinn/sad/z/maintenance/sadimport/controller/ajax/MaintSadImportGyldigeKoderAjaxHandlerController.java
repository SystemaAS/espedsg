...
public class MaintSadImportGyldigeKoderAjaxHandlerController {
	 ...
	 * @return
	 */
	@RequestMapping(value="getSpecificRecord_sad002_kodtsar.do", method={RequestMethod.GET, RequestMethod.POST})
	public @ResponseBody List <JsonMaintSadImportKodtsaRecord>getRecordSad002_kodtsa
	  	(@RequestParam String applicationUser, @RequestParam String id) {
		final String METHOD = "[DEBUG] getSpecificRecord_sad002_kodtsar.do ";
		logger.info(METHOD + " Inside...");
		List<JsonMaintSadImportKodtsaRecord> result = new ArrayList();
	 	//get table
	 ...
	 * @return
	 */
	@RequestMapping(value="getSpecificRecord_sad002_kodtsdr.do", method={RequestMethod.GET, RequestMethod.POST})
	public @ResponseBody List <JsonMaintSadImportKodtsdRecord>getRecordSad002_kodtsd
	  	(@RequestParam String applicationUser, @RequestParam String id) {
		final String METHOD = "[DEBUG] getSpecificRecord_sad002_kodtsdr.do ";
		logger.info(METHOD + " Inside...");
		List<JsonMaintSadImportKodtsdRecord> result = new ArrayList();
	 	//get table
