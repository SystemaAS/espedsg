 ...
 * 
 */
public class MaintSadImportKodts3Mapper {
	...
	public JsonMaintSadImportKodts3Container getContainer(String utfPayload) throws Exception{
		...
		JsonMaintSadImportKodts3Container container = mapper.readValue(utfPayload.getBytes(), JsonMaintSadImportKodts3Container.class); 
