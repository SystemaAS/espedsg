 ...
 * 
 */
public class MaintSadImportKodts2Mapper {
	...
	public JsonMaintSadImportKodts2Container getContainer(String utfPayload) throws Exception{
		...
		JsonMaintSadImportKodts2Container container = mapper.readValue(utfPayload.getBytes(), JsonMaintSadImportKodts2Container.class); 
