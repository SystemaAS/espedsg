...
/**
 * SAD NCTS Export Header Controller - child windows popup
 * 
...
@Scope("session")
public class SadNctsExportHeaderControllerChildWindow {
	
	private static final Logger logger = Logger.getLogger(SadNctsExportHeaderControllerChildWindow.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadnctsexport_edit_childwindow_generalcodes.do", params="action=doInit",  method={RequestMethod.GET} )
	public ModelAndView doInitGeneralCodes(@ModelAttribute ("record") JsonTvinnSadCodeContainer recordToValidate, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("tvinnsadnctsexport_edit_childwindow_generalcodes");
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadnctsexport_edit_childwindow_tullkontor.do", params="action=doInit",  method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doInitTullkontor(@ModelAttribute ("record") JsonTvinnSadTullkontorRecord recordToValidate, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("tvinnsadnctsexport_edit_childwindow_tullkontor");
		SystemaWebUser appUser = this.loginValidator.getValidUser(session);
		//check user (should be in session already)
		if(appUser==null){
			return this.loginView;
