...
public class SadNctsExportItemsController {
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadnctsexport_edit_items.do")
	public ModelAndView tvinnsadNctsExportEditItem(@ModelAttribute ("record") JsonSadNctsExportSpecificTopicItemRecord recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		logger.info("Inside: tvinnsadNctsExportEditItem");
		ModelAndView successView = new ModelAndView("tvinnsadnctsexport_edit_items");
