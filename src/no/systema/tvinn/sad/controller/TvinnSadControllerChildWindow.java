...
/**
 * SAD TVINN  Controller - Child Window popup
 * 
...
@Scope("session")
public class TvinnSadControllerChildWindow {
	
	private static final Logger logger = Logger.getLogger(TvinnSadControllerChildWindow.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsad_childwindow_customer.do", params="action=doFind",  method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView searchCustomer(HttpSession session, HttpServletRequest request){
		logger.info("Inside searchCustomer");
		
		ModelAndView successView = new ModelAndView("tvinnsad_childwindow_customer");
