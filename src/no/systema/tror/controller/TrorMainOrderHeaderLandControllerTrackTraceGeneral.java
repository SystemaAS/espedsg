...
@Scope("session")
public class TrorMainOrderHeaderLandControllerTrackTraceGeneral {
	private static final Logger logger = Logger.getLogger(TrorMainOrderHeaderLandControllerTrackTraceGeneral.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderland_ttrace_general.do", method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doInit( @ModelAttribute ("record") TrackfDao recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("tror_mainorderland_ttrace_general");
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderland_ttrace_general_edit.do",  method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doEditTrackAndTraceGeneral(@ModelAttribute ("record") TrackfDao recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		...
		logger.info("ACTION: " + action);
		ModelAndView successView = new ModelAndView("redirect:tror_mainorderland_ttrace_general.do?action=doFind" + params.toString() );
		ModelAndView errorView = new ModelAndView("tror_mainorderland_ttrace_general");
