...
/**
 * Tror - Order Header Child Controller 
 * 
...
@Scope("session")
public class TrorMainOrderHeaderChildController {
	private static final JsonDebugger jsonDebugger = new JsonDebugger(1500);
	private static Logger logger = Logger.getLogger(TrorMainOrderHeaderChildController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_landimportorder.do", method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doMainOrderEdit(@ModelAttribute ("record") JsonTrorOrderHeaderRecord recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("tror_landimportorder");
