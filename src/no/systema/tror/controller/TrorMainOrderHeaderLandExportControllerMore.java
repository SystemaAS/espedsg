...
/**
 * 
 * Tror Land Export Topic More Controller 
 * 
...
@Controller
@Scope("session")
public class TrorMainOrderHeaderLandExportControllerMore {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = Logger.getLogger(TrorMainOrderHeaderLandExportControllerMore.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderlandexport_more.do",  method= RequestMethod.GET)
	public ModelAndView doMore(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		//String messageFromContext = this.context.getMessage("user.label",new Object[0], request.getLocale());
		ModelAndView successView = new ModelAndView("tror_mainorderlandexport_more");
		logger.info("Method: doMore [RequestMapping-->tror_mainorderlandexport_more.do]");
	...
	@RequestMapping(value="tror_mainorderlandexport_more_ttrace.do",  method= RequestMethod.GET)
	public ModelAndView doMoreTrackAndTrace(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		//String messageFromContext = this.context.getMessage("user.label",new Object[0], request.getLocale());
		ModelAndView successView = new ModelAndView("tror_mainorderlandexport_more_ttrace");
		logger.info("Method: doMoreTrackAndTrace [RequestMapping-->tror_mainorderlandexport_more_ttrace.do]");
