 ...
 *
 */
public class TrorOrderFraktbrevValidator implements Validator {
	private static final Logger logger = Logger.getLogger(TrorOrderFraktbrevValidator.class.getName());
	//Init services here
	...
	public boolean supports(Class clazz) {
		return TrorOrderFraktbrevValidator.class.isAssignableFrom(clazz); 
	}
